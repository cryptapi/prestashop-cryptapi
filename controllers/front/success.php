...
class CryptAPISuccessModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        $this->context->smarty->assign([
            ...
            'total' => CryptAPIHelper::sig_fig($metaData['cryptapi_total_fiat'], 2),
            'qrcode_size' => (int) Configuration::get('cryptapi_qrcode_size') + 20,
            'qrcode_default' => (string) Configuration::get('cryptapi_qrcode_default') === '0' ? false : true,
            'show_branding' => (string) Configuration::get('cryptapi_show_branding') === '0' ? false : true,
